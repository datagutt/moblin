...
class SettingsDebug: Codable, ObservableObject {
    ...
    @Published var srtlaPredictiveScheduler: Bool = false
    ...
    func encode(to encoder: any Encoder) throws {
        ...
        try container.encode(.srtlaPredictiveScheduler, srtlaPredictiveScheduler)
    }
    ...
    required init(from decoder: any Decoder) throws {
        ...
        srtlaPredictiveScheduler = container.decode(.srtlaPredictiveScheduler, Bool.self, false)
    }
}
